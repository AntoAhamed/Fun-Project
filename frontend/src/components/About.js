        ...
        <div className='container'>
            ...
            <div className={`row mb-3 bg-${mode}`}>
                <div className='col fs-5 p-4'>
                    ...
                    <p>
                        Hi. I am <b>Md. Nazirul Mobin Ahamed</b>, developer of this application, want to make our daily life easier by organizing useful tools in one place. At <strong>Toolbox</strong>, we understand that taking notes, setting alarms or reminder is an essential part of daily life. Whether you're a student, a professional, or just someone who likes to keep things organized, having a reliable and user-friendly toolkit app can make all the difference.
                        ...
                        I take pride in my commitment to user privacy and data security. User data will be saved at their own device. So, there is no question in that. This is built on a solid foundation of secure coding practices, and I will continuously update our app to ensure that your life will be more easire then before.
